...
def main():
    ...
    parser.add_argument("--server_port", required=True, help="server port")
    parser.add_argument("--ft_endpoint", required=True, help="ft endpoint: http://ip:port/endpoint")
    parser.add_argument("--rag_endpoint", required=True, help="rag endpoint: http://ip:port/endpoint")

    args = parser.parse_args()

    global_config["server_ip"] = args.server_ip
    global_config["server_port"] = args.server_port
    global_config["ft_endpoint"] = args.ft_endpoint
    global_config["rag_endpoint"] = args.rag_endpoint

    uvicorn.run(app, host=global_config["server_ip"], port=int(global_config["server_port"]))
